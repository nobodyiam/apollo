 ...
 * <p>
 * It is an alternative base class to FilterInputStream to increase reusability, because
 * FilterInputStream changes the methods being called, such as read(byte[]) to read(byte[], int,
 * int).
 * <p>
 * See the protected methods for ways in which a subclass can easily decorate a stream with custom
 * pre-, post- or error processing functionality.
 *
...
public abstract class ProxyInputStream extends FilterInputStream {
   ...
   * <p>
   * Note this method is <em>not</em> called from {@link #skip(long)} or {@link #reset()}. You need
   * to explicitly override those methods if you want to add pre-processing steps also to them.
   *
   ...
   * <p>
   * Subclasses can override this method to add common post-processing functionality without having
   * to override all the read methods. The default implementation does nothing.
   * <p>
   * Note this method is <em>not</em> called from {@link #skip(long)} or {@link #reset()}. You need
   * to explicitly override those methods if you want to add post-processing steps also to them.
   *
