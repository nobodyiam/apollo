...
/**
 * This class contains collections of methods to access Apollo Open Api. <br /> For more
 * information, please refer <a href="https://github.com/ctripcorp/apollo/wiki/">Apollo Wiki</a>.
 */
public class ApolloOpenApiClient {
  ...
  public static class ApolloOpenApiClientBuilder {
    ...
    public ApolloOpenApiClient build() {
      ...
      Preconditions
          .checkArgument(portalUrl.startsWith("http://") || portalUrl.startsWith("https://"),
