...
public class ReleaseCreationTest extends AbstractIntegrationTest {
   ...
   *    | ---------------------------- k2=v2     | k1=v1    |    k1=v1 k3=v3
   *    publish master                 k2=v2    | k2=v2 ------------------------------
   ...
   * Master     |      Branch ------------------------------ Master    |    Branch Items      k1=v1
   *    |      k1=v1-2 ------------------------- k2=v2     |
   *             k1=v1 |    k1=v1 k3=v3                            publish master
  ...
  /**
   * Master     |      Branch ------------------------------ Master    |    Branch Items      k1=v1
   *    |      k1=v1-2 ---------------------------- k2=v2-2    |                      publish master
   * k1=v1    |    k1=v1-1 ------------------------------        ===========>>      Result k2=v2-2
   * |    k2=v2-2 Release     k1=v1     |      k1=v1-1 | k2=v2     |      k2=v3 k3=v3     |
   * k3=v3
   */
  @Test
  @Sql(scripts = "/sql/release-creation-test.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
  ...
  /**
   * Master     |      Branch ------------------------------ Master    |    Branch Items      k1=v1
   *    |      k1=v1-2 ---------------------------- k2=v2-2    |      k4=v4           publish branch
   * k1=v1    |    k1=v1-2 ------------------------------        ===========>>      Result k2=v2
   * |    k2=v2 Release     k1=v1     | k3=v3    |    k3=v3 k2=v2     |
   * | k4=v4 k3=v3     |
   */
  @Test
  @Sql(scripts = "/sql/release-creation-test.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
  ...
  /**
   * Master     |      Branch ------------------------------ Master    |    Branch Items      k1=v1
   *    |      k1=v1-2 ---------------------------- k2=v2-2    |      k4=v4 k1=v1    |    k1=v1-2
  ...
  /**
   * Master     |      Branch ------------------------------ Master   |    Branch Rollback Release
   *    k1=v1     |      k1=v1-2 ---------------------------- k2=v2     |      k2=v2 k1=v1-1    |
   * k1=v1-2 |      k3=v3                                        k2=v2-1    | k2=v2-1 rollback
   *               k3=v3      |    k3=v3 ------------------------------ ===========>>   New Release
   * New  Release           k1=v1-1   | k2=v2-1   | k3=v3     |
   */
  @Test
  @Sql(scripts = "/sql/release-creation-test.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
  @Sql(scripts = "/sql/clean.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
