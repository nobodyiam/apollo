...
public class JavaConfigPlaceholderAutoUpdateTest extends AbstractSpringIntegrationTest {
  ...
  private SimpleConfig prepareConfig(String namespaceName, Properties properties) {
  ...
  private Properties assembleProperties(String key, String value) {
  ...
  private Properties assembleProperties(String key, String value, String key2, String value2) {
    Properties properties = new Properties();
    properties.setProperty(key, value);
