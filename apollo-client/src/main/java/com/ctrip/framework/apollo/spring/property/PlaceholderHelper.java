...
public class PlaceholderHelper {
  ...
  /**
   * Resolve placeholder property values, e.g. <br /> <br /> "${somePropertyValue}" -> "the actual
   * property value"
   */
  ...
  private boolean isExpressionWithPlaceholder(String propertyString) {
    return propertyString.startsWith(EXPRESSION_PREFIX) && propertyString
        .contains(EXPRESSION_SUFFIX)
        && propertyString.contains(PLACEHOLDER_PREFIX) && propertyString
        .contains(PLACEHOLDER_SUFFIX);
  }
