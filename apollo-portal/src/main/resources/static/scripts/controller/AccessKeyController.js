    ...
    UserService.load_user().then(function (result) {
      ...
      .then(function () {
        ...
        toastr.error(AppUtil.errorMsg(result),
            $translate.instant('AccessKey.Operator.CreateError', {env}));
      });
    });
  }
  ...
  function remove(id, env) {
    ...
    if (confirm(confirmTips)) {
      ...
      .then(function () {
        ...
        toastr.error(AppUtil.errorMsg(result),
            $translate.instant('AccessKey.Operator.RemoveError', {env}));
      });
    }
  }
  ...
  function enable(id, env) {
    ...
    if (confirm(confirmTips)) {
      ...
      .then(function () {
        ...
        toastr.error(AppUtil.errorMsg(result),
            $translate.instant('AccessKey.Operator.EnabledError', {env}));
      });
    }
  }
  ...
  function disable(id, env) {
    ...
    if (confirm(confirmTips)) {
      ...
      .then(function () {
        ...
        toastr.error(AppUtil.errorMsg(result),
            $translate.instant('AccessKey.Operator.DisabledError', {env}));
      });
    }
  }
}
