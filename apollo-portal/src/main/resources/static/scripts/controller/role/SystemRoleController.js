...
.controller('SystemRoleController',
    ['$scope', '$location', '$window', '$translate', 'toastr', 'AppService', 'UserService',
      ...
      function SystemRoleController($scope, $location, $window, $translate, toastr, AppService,
          UserService, AppUtil, EnvService,
          PermissionService, SystemRoleService) {
        ...
        $scope.addCreateApplicationRoleToUser = function () {
          ...
          .then(
              ...
              function (reason) {
                toastr.warning(AppUtil.errorMsg(reason),
                    $translate.instant('SystemRole.AddFailed'));
              }
          );
        };
        ...
        $scope.deleteCreateApplicationRoleFromUser = function (userId) {
          ...
          .then(
              ...
              function (reason) {
                toastr.warn(AppUtil.errorMsg(reason),
                    $translate.instant('SystemRole.DeleteFailed'));
              }
          );
        };
        ...
        function getCreateApplicationRoleUsers() {
          ...
          .then(
              ...
              function (reason) {
                toastr.warning(AppUtil.errorMsg(reason),
                    $translate.instant('SystemRole.GetCanCreateProjectUsersError'));
              }
          )
        }
        ...
        $scope.getAppInfo = function () {
          ...
          AppService.load($scope.app.appId).then(function (result) {
            if (!result.appId) {
              toastr.warning(
                  $translate.instant('SystemRole.AppIdNotFound', {appId: $scope.app.appId}));
              $scope.operateManageAppMasterRoleBtn = true;
              return;
            }
        ...
        $scope.deleteAppMasterAssignRole = function () {
          ...
          if (confirm(confirmTips)) {
            AppService.delete_app_master_assign_role($scope.app.appId, user.id).then(
                function (result) {
        ...
        $scope.allowAppMasterAssignRole = function () {
          ...
          if (confirm(confirmTips)) {
            AppService.allow_app_master_assign_role($scope.app.appId, user.id).then(
                function (result) {
