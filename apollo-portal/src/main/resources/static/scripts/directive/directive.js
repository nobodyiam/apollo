...
directive_module.directive('apolloclusterselector',
    function ($compile, $window, AppService, AppUtil, toastr) {
      return {
        restrict: 'E',
            ...
            AppService.load_nav_tree(scope.appId).then(function (result) {
              ...
              envClusterInfo.forEach(function (node) {
                ...
                node.clusters.forEach(function (cluster) {
                  ...
                  //not checked
                  if (cluster.env == scope.notCheckedEnv && cluster.name
                      == scope.notCheckedCluster) {
...
/**  确认框 */
directive_module.directive('apolloconfirmdialog',
    function ($compile, $window, $sce, $translate, AppUtil) {
      return {
        restrict: 'E',
