...
function releaseModalDirective($translate, toastr, AppUtil, EventManager, ReleaseService,
    ...
    link: function (scope) {
        ...
        ReleaseService.publish(scope.appId, scope.env,
            ...
            function (result) {
              ...
              toastr.error(AppUtil.errorMsg(result),
                  $translate.instant('ReleaseModal.PublishFailed'));
      ...
      function grayPublish() {
        ...
        ReleaseService.grayPublish(scope.appId, scope.env,
            ...
            function (result) {
              ...
              scope.releaseBtnDisabled = false;
              toastr.error(AppUtil.errorMsg(result),
                  $translate.instant('ReleaseModal.GrayscalePublishFailed'));
      ...
      function mergeAndPublish() {
        ...
        .then(function (result) {
          ...
          toastr.error(AppUtil.errorMsg(result),
              $translate.instant('ReleaseModal.AllPublishFailed'));
        });
