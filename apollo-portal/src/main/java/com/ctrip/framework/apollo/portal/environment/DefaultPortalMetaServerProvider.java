...
/**
 * Only use in apollo-portal load all meta server address from - System Property           [key ends
 * with "_meta" (case insensitive)] - OS environment variable   [key ends with "_meta" (case
 * insensitive)] - user's configuration file [key ends with ".meta" (case insensitive)] when
 * apollo-portal start up.
 *
 * @author wxq
...
class DefaultPortalMetaServerProvider implements PortalMetaServerProvider {
  ...
  private static final Logger logger = LoggerFactory
      .getLogger(DefaultPortalMetaServerProvider.class);
